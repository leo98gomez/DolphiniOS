...
// From android files. Needs to have own file
...
// Wiimote
#include "Core/HW/WiimoteReal/WiimoteReal.h"
WiimoteReal::WiimoteScanner::WiimoteScanner()
{}

WiimoteReal::WiimoteScanner::~WiimoteScanner()
{}

void WiimoteReal::WiimoteScanner::Update()
{}

void WiimoteReal::WiimoteScanner::FindWiimotes(std::vector<Wiimote*>& found_wiimotes, Wiimote*& found_board)
{
